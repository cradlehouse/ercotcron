  ...
  return (
    <div className="min-h-screen bg-ink text-[#f2f6f6]">
      ...
      <section className="mx-auto max-w-5xl px-6 pb-16 pt-14">
        ...
        <p className="mt-4 max-w-xl text-base leading-relaxed text-[#93a6ab]">
      ...
      <section id="market" className="border-t border-line">
        <div className="mx-auto max-w-6xl px-6 py-12">
          <div className="text-base font-medium">The whole market, on the record</div>
          <p className="mt-2 max-w-[75ch] text-sm leading-relaxed text-[#93a6ab]">
      ...
      <section id="products" className="border-t border-line">
        <div className="mx-auto grid max-w-5xl gap-8 px-6 py-12 sm:grid-cols-3">
          <div>
            <div className="text-base font-medium">Auction bid sheets</div>
          ...
          <div>
            <div className="text-base font-medium">Constraint alerts</div>
            <p className="mt-2 text-sm leading-relaxed text-[#93a6ab]">
          ...
          <div>
            <div className="text-base font-medium">Exit &amp; book valuation</div>
            <p className="mt-2 text-sm leading-relaxed text-[#93a6ab]">
      ...
      <section id="method" className="border-t border-line">
        <div className="mx-auto max-w-5xl px-6 py-12">
          <div className="text-base font-medium">Why trust the numbers</div>
          <div className="mt-4 grid gap-6 text-sm leading-relaxed text-[#93a6ab] sm:grid-cols-3">
            <p>
