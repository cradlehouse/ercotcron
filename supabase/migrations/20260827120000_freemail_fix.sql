-- Security fix caught in live testing: domain-match auto-approval treated
-- gmail.com == gmail.com as ownership proof. Free-mail domains now require an
-- EXACT address match; only corporate domains keep the same-domain shortcut.
